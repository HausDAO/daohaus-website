...
- Learn the <Link to='/docs/contexts'>structure of the app </Link>.
- If you're tasked with interacting with a contract (TXs), learn the <Link to='/docs/tx-polling'>TX/polling/test cycle </Link>.
...
- If you're not comfortable with Async, take some time to browse <Link to='/docs/async-await'>some examples </Link>in the docs. Check out some tutorials.
