...
Contributors are the lifeblood of all DAOs, so we take Contributor Experience & Compensation seriously and are always iterating on it. Contributor Compensation should achieve the following objectives:
