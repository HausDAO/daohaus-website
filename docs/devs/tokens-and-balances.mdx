...
The DAOhaus app displays token balances and prices from the DAO treasury. ERC-20 token prices are fetched from Coingecko's price APIs, whereas the token icons are fetched from TrustWallet's repository.
**Minions**
