...
## Steps
These steps assume that you've been added to the DAOhaus Coordinape Circle. If you (or someone else you've worked with) need to be added, [please vouch](https://app.coordinape.com/vouching) for who it is that needs to be added
