...
| specialPol<sup>[1](#sub1)</sup>     |   STRING        | Until then, we can use `specialPoll` to interact with the many customPolls in PollService.js. Just add the name of the poll to this field.
