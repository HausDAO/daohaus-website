...
Membership in a DAO can be very fluid. Easy in/easy out. Prospective members submit Membership Proposals, and existing members can vote them in or not. Members can exit at anytime\*.

\* As long as they don't have a 'Yes' vote on an open proposal
