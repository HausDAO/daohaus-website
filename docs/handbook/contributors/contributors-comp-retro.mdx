...
- `Description / Proof of Work`: a list of your contributions to this Circle during Month A. This includes your participation in meetings, discussions and learning. The more evidence you can provide &mdash; such as links to documents written, code commits / PRs, etc &mdash; the more likely your Circle is to accept your request.
