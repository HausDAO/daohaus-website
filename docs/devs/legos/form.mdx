...
Can check anything inside of the application. If you want to add a custom validation head to `src/utils/validation.js`

#### ctaText

(STRING)

Call To Action text. Or the name of the submit button on the form.

#### blurText

(STRING)

If valdation isn't fulfulled this the is the text on the blur.

#### formConditions

(ARRAY OF STRINGS)

Can change state of form based on specified condition.

#### customWidth

(STRING)

Specifies width of form modal (800px - example).

#### logValues

(BOOLEAN)

To log values of values of subject. Set to true debug.
