...
A: After the voting period has ended, when a proposal is ready to be processed, you will see whether or not the proposal passed/failed.  If no one voted on the proposal, it will automatically fail.
