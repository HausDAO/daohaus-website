...
All of the documentation is written in Markdown, a lightweight markup language for creating formatted text using a plain-text-editor.  All headers should be in H3 size, using the "###" notation in Markdown.
